...
\begin{figure}
\begin{center}
	\includegraphics[scale=0.56]{shared_phyla}
...
diseases had less obviously apparent microbial indicators of disease (Figure \ref{fig:pval_heatmap}). We also observed that some bacteria
...
with disease in general, while many genera in the families \textit{Lachnospiraceae}, \textit{Ruminococcaceae}, and \textit{Erysipelotrichaceae} were associated with healthy controls.
...
\begin{figure}[h]
	...
	\caption{Heatmap of significant associations.}
...
\begin{figure}[h]
	...
	\caption{Tree of exchange microbes. TODO: ITOL citation, brah.}
