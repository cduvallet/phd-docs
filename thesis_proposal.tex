...
themes or functions on their own (GSEA REF). 
...
metabolomics studies (\cite{subramanian-gsea-2005}, \cite{xia-
msea-2010}. In Gene Set Enrichment Analysis (GSEA), genes are first 
...
not span all categories of possible interest (IMG REF). SourceTracker 
...
in order to learn and make the classifications (REF SOURCETRACKER). 
Finally, bioinformatic tools have been developed that can functional 
content (PICRUST) or metabolic pathways (HUMANN) from 16S data. Again, 
...
To perform a comprehensive meta-analysis, we need to collect a 
...
developed by Thomas Gurry and to which I have contributed. We will 
